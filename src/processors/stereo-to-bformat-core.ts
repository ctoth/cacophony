...
class CrossCorrelator {
  private smoothedLL = 0;
  private smoothedRR = 0;
  private smoothedLR = 0;
  private readonly alpha: number;
  private readonly oneMinusAlpha: number;

  constructor(alpha: number = COHERENCE_SMOOTHING_ALPHA) {
    this.alpha = alpha;
...
export class StereoToFoaUpmixer {
  ...
  private readonly lowCoherence: CrossCorrelator;
  private readonly midCoherence: CrossCorrelator;
  private readonly highCoherence: CrossCorrelator;
