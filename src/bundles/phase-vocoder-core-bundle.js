var phaseVocoderCore = (function (exports) {
    'use strict';
     ...
     */
    function peakRotator(peakIndex, peakIndexShifted, fftSize, timeCursor) {
     ...
     */
    function regionOfInfluence(peakIndexes, i, nbPeaks, fftSize) {
     ...
     */
    function shiftPeaks(complex, shifted, peakIndexes, nbPeaks, fftSize, magnitudesLength, pitchFactor, timeCursor) {
        shifted.fill(0);
    ...
    exports.peakRotator = peakRotator;
    exports.regionOfInfluence = regionOfInfluence;
    exports.shiftPeaks = shiftPeaks;

    return exports;

})({});
//# sourceMappingURL=phase-vocoder-core-bundle.js.map
