var waveshaper = (function (exports) {
    'use strict';
     ...
     */
    const SHAPE_BY_INDEX = ["hardclip", "tanh"];
    function shapeFromIndex(index) {
        const i = Math.round(index);
        return SHAPE_BY_INDEX[i] ?? "hardclip";
    }
    class WaveshaperWorkletProcessor extends AudioWorkletProcessor {
    ...
    exports.WaveshaperWorkletProcessor = WaveshaperWorkletProcessor;

    return exports;

})({});
//# sourceMappingURL=waveshaper-bundle.js.map
