var dynamicsCore = (function (exports) {
    'use strict';
     ...
     */
    function computeStaticGain(xG, threshold, ratio, knee) {
     ...
     */
    function timeConstantToCoefficient(tau, sampleRate) {
        if (tau <= 0)
            return 0; // degenerate: instantaneous response
    ...
    class DynamicsProcessor {
         ...
         */
        processSample(x, threshold, ratio, knee, alphaAttack, alphaRelease, makeup) {
        ...
        process(input, output, params) {
            ...
            for (let i = 0; i < n; i++) {
                output[i] = this.processSample(input[i], params.threshold, params.ratio, params.knee, alphaAttack, alphaRelease, params.makeup);
            }
        }
    }

    exports.DYNAMICS_DEFAULTS = DYNAMICS_DEFAULTS;
    exports.DynamicsProcessor = DynamicsProcessor;
    exports.GATE_DEFAULT_RATIO = GATE_DEFAULT_RATIO;
    exports.computeStaticGain = computeStaticGain;
    exports.timeConstantToCoefficient = timeConstantToCoefficient;

    return exports;

})({});
//# sourceMappingURL=dynamics-core-bundle.js.map
