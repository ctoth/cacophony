var barberpole = (function (exports) {
    'use strict';
    ...
    class BarberpoleWorkletProcessor extends AudioWorkletProcessor {
        cores = [];
        ...
        process(inputs, outputs, parameters) {
            ...
            for (let channel = 0; channel < output.length; channel++) {
                ...
                if (!source)
                    ...
                    (this.cores[channel] ??= new BarberpoleCore(sampleRate)).process(source, output[channel], params);
            }
            return true;
        }
    }
    ...
    exports.BarberpoleWorkletProcessor = BarberpoleWorkletProcessor;

    return exports;

})({});
//# sourceMappingURL=barberpole-bundle.js.map
